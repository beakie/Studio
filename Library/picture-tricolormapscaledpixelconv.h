#ifndef PICTURE_TRICOLORMAPSCALEDPIXELCONV_H
#define PICTURE_TRICOLORMAPSCALEDPIXELCONV_H
...
namespace Picture
{
	...
	class TriColorMapScaledPixelConv : Common::IPixelConverter<TVALUEIN, Common::Vector3<TVALUEOUT>>
	{
	private:
...
#endif // PICTURE_TRICOLORMAPSCALEDPIXELCONV_H
